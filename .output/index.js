...
import nuxt_plugin_plugin_1d821bcc from 'nuxt_plugin_plugin_1d821bcc' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_workbox_0f035719 from 'nuxt_plugin_workbox_0f035719' // Source: .\\workbox.js (mode: 'client')
import nuxt_plugin_metaplugin_b553bace from 'nuxt_plugin_metaplugin_b553bace' // Source: .\\pwa\\meta.plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_1d821bcc === 'function') {
    await nuxt_plugin_plugin_1d821bcc(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_0f035719 === 'function') {
    await nuxt_plugin_workbox_0f035719(app.context, inject)
  }

  if (typeof nuxt_plugin_metaplugin_b553bace === 'function') {
    await nuxt_plugin_metaplugin_b553bace(app.context, inject)
  }
